 ...
 * @Last modified time: 2019-09-20T01:03:49+10:00
 */
...
// Close closes current caster and all subscriber channels. Ok value indicates whether current
// caster has already been closed and stopped receiving further operations.
...
// Sub subscribes to current caster and returns a new channel for the subscriber to receive the
// broadcasting message. When the given ctx is canceled, current caster will unsubscribe the
// subscriber channel and close it. Ok value indicates whether current caster has already
// been closed and stopped receiving further operations.
...
// indicates whether current caster has already been closed and stopped receiving further operations.
...
// to all subscriber channels. Ok value indicates whether current caster has already been closed and
// stopped receiving further operations.
...
// receiving. Ok value indicates whether current caster has already been closed and stopped
// receiving further operations.
